...
def _load_model_and_alphabet_core_v1(model_data):
    import esm_model  # since esm.inverse_folding is imported below, you actually have to re-import esm here

    alphabet = esm_model.Alphabet.from_architecture(model_data["args"].arch)
    ...
    if model_data["args"].arch == "roberta_large":
        ...
        model_type = esm_model.ProteinBertModel
        ...
        model_type = esm_model.MSATransformer

    elif "invariant_gvp" in model_data["args"].arch:
        import esm.inverse_folding

        model_type = esm_model.inverse_folding.gvp_transformer.GVPTransformerModel
...
def _load_model_and_alphabet_core_v2(model_data):
    ...
    alphabet = esm_model.data.Alphabet.from_architecture("ESM-1b")
    model = ESM2(
